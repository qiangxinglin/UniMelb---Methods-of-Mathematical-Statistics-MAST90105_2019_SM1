...
$$
\begin{align}
var(\hat{c}) &= \frac{1}{4n} \bigg(-4c^2 + \frac{10}{3}c + \frac{3}{4}\bigg) \quad (X_1, \dots , X_n \text{ i.i.d}) \\
\end{align}
$$
...
$$
\begin{align}
\frac{\partial^2 lnL(c)}{(\partial c)^2} &= m\frac{1}{c} - (n-m)\frac{1}{1-c} \stackrel{set}{=} 0 \\
m\frac{1}{c} &= (n-m)\frac{1}{1-c} \quad (c \neq 0, 1) \\
c &= \frac{m}{n} \\
\end{align}
$$
